function out = Dual_SS_Extended(sim, d, T, type, obj)
%extended superstability from https://link.springer.com/article/10.1023/B:AURC.0000023533.13882.13#citeas
%turns out it is convex and nice
...
switch type
    case 'no_prior'
        ...
        B = sdpvar(n,m,'full');
        vars = [A(:);B(:)];
    case 'prior'     % second column of A known in case of a 2x2 demo
